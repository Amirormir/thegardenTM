      ...
      {teams.map((team, index) => (
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div className="flex min-w-0 items-center gap-3">
              <div className="rounded-2xl border border-white/12 bg-white/10 px-3 py-2 text-center">
                <p className="text-[0.62rem] uppercase tracking-[0.08em] text-white/58">Rank</p>
                <p className="font-display text-2xl font-bold tracking-tight text-white">#{index + 1}</p>
              </div>
              <TeamAvatar
                name={team.name}
              ...
              <div className="min-w-0">
                <p className="truncate font-display text-2xl font-bold tracking-tight text-white">{team.name}</p>
                <p className="text-xs uppercase tracking-[0.06em] text-white/62">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/[0.05] bg-white/[0.04] px-4 py-3">
